# RE-Peater
This tool is intended to print user defined text to the standard output at user defined intervals. Mainly intended to help debug RE-Actor.

Here are the variables used to configure [RE-Peater](https://github.com/SusanHex/RE-Actor "Reactors Github"):
